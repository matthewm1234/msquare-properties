...
const Navbar = () => {
  ...
  return (
    <nav className='bg-blue-700 border-b border-blue-500'>
        ...
        <div className='relative flex h-20 items-center justify-between'>
          ...
          <div className='flex flex-1 items-center justify-center md:items-stretch md:justify-start'>
            ...
            <Link className='flex flex-shrink-0 items-center' to='/'>
              {/* src='images/logo.png' fails for /properties/add */}
              <img className='h-10 w-auto' src='/images/logo.png' alt='M²Property' />
      ...
      {isMobileMenuOpen && (
        <div id='mobile-menu' className="relative z-50 bg-blue-700">
          <div className='space-y-1 px-2 pb-3 pt-2'>
            <Link
              to='/'
              className={`${pathname === '/' ? 'bg-black' : ''} text-white block rounded-md px-3 py-2 text-base font-medium w-100`}
            >
              Home
            </Link>
            <Link
